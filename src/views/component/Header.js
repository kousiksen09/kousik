...
import { Typography, AppBar, Toolbar, useMediaQuery, useTheme, Avatar } from "@material-ui/core";
	...
	<Toolbar className={classes.headerDesk}>
		<Link to="/">
			<div className={classes.mobileTab}>
				<AccountCircleIcon
					className={clsx(currentPage === "About Me" ? classes.largeOn : classes.large)}
				/>
				<Typography
					className={clsx(
						currentPage === "About Me" ? classes.headerTextOn : classes.headerText
					)}
				>
					About
				</Typography>
		...
		<Link to="/education">
			<div className={classes.mobileTab}>
				<MenuBookIcon
					className={clsx(
						currentPage === "Education & Skill" ? classes.largeOn : classes.large
					)}
				/>
				<Typography
					className={clsx(
		...
		<Link to="/project">
			<div className={classes.mobileTab}>
				<ComputerIcon
					className={clsx(currentPage === "Project" ? classes.largeOn : classes.large)}
				/>
				<Typography
					className={clsx(
						currentPage === "Project" ? classes.headerTextOn : classes.headerText
					)}
				>
					Project
				</Typography>
		...
		<Link to="/training">
			<div className={classes.mobileTab}>
				<WebIcon
					className={clsx(
						currentPage === "Training & Internship" ? classes.largeOn : classes.large
					)}
				/>
				<Typography
					className={clsx(
		...
		<Link to="/contact">
			<div className={classes.mobileTab}>
				<ContactsIcon
					className={clsx(currentPage === "Contact" ? classes.largeOn : classes.large)}
				/>
				<Typography
					className={clsx(
						currentPage === "Contact" ? classes.headerTextOn : classes.headerText
					)}
				>
					Contact
				</Typography>
